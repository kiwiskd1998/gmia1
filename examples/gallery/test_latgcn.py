...
from examples.gallery.model.latgcn import LATGCN
...
data = Dataset(root='E:/yanjiusheng/code/tmp', name="cora", setting='nettack')
# perturbed_data = PtbDataset(root='D:/yanjiusheng/code/DeepRobust-master/tmp', name="polblogs")
...
plt.text(0, 2, "train:red",bbox=dict(facecolor='white', alpha=0.5), fontsize=10)
plt.text(0, 1.75, "test:blue",bbox=dict(facecolor='white', alpha=0.5), fontsize=10)
plt.show()
#import random
