...
data = Dataset(root='D:/yanjiusheng/code/DeepRobust-master/tmp', name=args.dataset)
...
#                 nhid=16, dropout=0, with_relu=False, with_bias=True, device=device)
adv_train_model = torch.load("minmax_adv/polblogs_32.pt")
...
#     adversary.attack(adj, n_perturbations=n_perturbations, type='remove')
...
for target_node in target_nodes:
    # set up Nettack
    adversary = Nettack(surrogate, nnodes=adj.shape[0], attack_structure=True, attack_features=False, device=device)
