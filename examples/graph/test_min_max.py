...
data = Dataset(root='D:/yanjiusheng/code/DeepRobust-master/tmp', name=args.dataset, setting='nettack')
...
# victim_model = torch.load("gcn_model/")
# Setup Attack Model

model = MinMax(model=victim_model, nnodes=adj.shape[0], loss_type='CW', device=device)
